...
mer 1:1 household_id round using "${tmp_hfps_eth}/panel/cover.dta", keepus(household_id round) assert(2 3)
...
sa "${tmp_hfps_eth}/panel/access.dta", replace 
u  "${tmp_hfps_eth}/panel/access.dta", clear 
