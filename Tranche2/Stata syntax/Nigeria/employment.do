...
#d cr
	...
	mer 1:1 hhid round using "${tmp_hfps_nga}/panel/cover.dta"
	ta round _m	//	perfect
	keep if _m==3
	ta s12q5
	ta s12q5 s6q1,m
...
mer m:1 hhid indiv round using "${tmp_hfps_nga}/panel/ind.dta", keep(1 3)
ta round _m, nol
...
isid hhid round
sort hhid round
sa "${tmp_hfps_nga}/panel/employment.dta", replace 


ex 	
dir "${tmp_hfps_nga}/panel"
u  "${tmp_hfps_nga}/panel/employment.dta", clear 
