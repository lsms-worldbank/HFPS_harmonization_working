...
mer 1:1 hhid round using "${tmp_hfps_bfa}/panel/cover.dta", keepus(strate)
...
isid hhid round item
sort hhid round item
sa "${tmp_hfps_bfa}/panel/access.dta", replace 
u  "${tmp_hfps_bfa}/panel/access.dta", clear 
d, s
ta item round
