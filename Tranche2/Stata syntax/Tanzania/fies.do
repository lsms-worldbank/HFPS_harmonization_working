...
mer 1:1 round hhid using "${tmp_hfps_tza}/panel/cover.dta", keepus(s10q01 urban_rural wgt)
ta round _m
...
mer 1:1 round hhid using "${tmp_hfps_tza}/panel/demog.dta", keepus(hhsize)
ta round _m
ta s10q01 _m
keep if _m==3
drop _m s10
...
sa "${tmp_hfps_tza}/panel/fies.dta", replace
