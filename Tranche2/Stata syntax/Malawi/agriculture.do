...
// mer 1:1 y4 round using "${tmp_hfps_mwi}/panel/cover.dta", keepus(hh_a00)	
...
isid  y4_hhid round
sort  y4_hhid round
sa "${tmp_hfps_mwi}/panel/agriculture.dta", replace 
u  "${tmp_hfps_mwi}/panel/agriculture.dta", clear 
