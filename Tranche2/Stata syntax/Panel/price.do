...
d using "${tmp_hfps_bfa}/panel/price.dta"
d using "${tmp_hfps_eth}/panel/price.dta"
d using "${tmp_hfps_mwi}/panel/price.dta"
d using "${tmp_hfps_nga}/panel/price.dta"
d using "${tmp_hfps_tza}/panel/price.dta"
d using "${tmp_hfps_uga}/panel/price.dta"
...
u 									"${tmp_hfps_eth}/panel/price.dta", clear
...
u 							"${tmp_hfps_mwi}/panel/price.dta", clear
...
u							"${tmp_hfps_nga}/panel/price.dta", clear
...
u							"${tmp_hfps_tza}/panel/price.dta", clear
...
u							"${tmp_hfps_uga}/panel/price.dta", clear
