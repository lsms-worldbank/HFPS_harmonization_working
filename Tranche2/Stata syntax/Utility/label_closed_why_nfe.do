...
label define closed_why_nfe  4 `"CANNOT GET INPUTS"', modify
label define closed_why_nfe  5 `"CANNOT TRAVEL / TRANSPORT GOODS FOR TRADE"', modify
...
*	uganda
label define closed_why_nfe 14 `"SELL PRICE TOO LOW"', modify
label define closed_why_nfe 15 `"UNRELIABLE ELECTRICITY"', modify

*	tanzania
label define closed_why_nfe 16 `"RETIRED"', modify

*	ethiopia
label define closed_why_nfe 17 `"SECURITY ISSUES"', modify




cap : la val closed_why_nfe closed_why_nfe
if _rc==0 {
inspect closed_why_nfe
assert `r(N_undoc)'==0
}
