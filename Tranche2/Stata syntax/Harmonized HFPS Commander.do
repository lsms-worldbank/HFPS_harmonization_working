...
gl do_hfps_bfa		"${hfps_github}/Stata syntax/Burkina Faso"
gl do_hfps_eth		"${hfps_github}/Stata syntax/Ethiopia"
gl do_hfps_mwi		"${hfps_github}/Stata syntax/Malawi"
gl do_hfps_nga		"${hfps_github}/Stata syntax/Nigeria"
gl do_hfps_tza		"${hfps_github}/Stata syntax/Tanzania"
gl do_hfps_uga		"${hfps_github}/Stata syntax/Uganda"
gl do_hfps_pnl		"${hfps_github}/Stata syntax/Panel"
gl do_hfps_util		"${hfps_github}/Stata syntax/Utility"	//	this will be the ado repository 
adopath + "${do_hfps_util}"
dir "${do_hfps_util}"

gl tmp_hfps_bfa		"${hfps_github}/Temporary datasets/Burkina Faso"
gl tmp_hfps_eth		"${hfps_github}/Temporary datasets/Ethiopia"
gl tmp_hfps_mwi		"${hfps_github}/Temporary datasets/Malawi"
gl tmp_hfps_nga		"${hfps_github}/Temporary datasets/Nigeria"
gl tmp_hfps_tza		"${hfps_github}/Temporary datasets/Tanzania"
gl tmp_hfps_uga		"${hfps_github}/Temporary datasets/Uganda"
gl tmp_hfps_pnl		"${hfps_github}/Temporary datasets/Panel"

gl final_hfps_bfa	"${hfps_github}/Final datasets/Burkina Faso"
gl final_hfps_eth	"${hfps_github}/Final datasets/Ethiopia"
gl final_hfps_mwi	"${hfps_github}/Final datasets/Malawi"
gl final_hfps_nga	"${hfps_github}/Final datasets/Nigeria"
gl final_hfps_tza	"${hfps_github}/Final datasets/Tanzania"
gl final_hfps_uga	"${hfps_github}/Final datasets/Uganda"
gl final_hfps_pnl	"${hfps_github}/Final datasets/Panel"

gl excel_hfps_bfa	"${hfps_github}/Excel documentation/Burkina Faso"	
gl excel_hfps_eth	"${hfps_github}/Excel documentation/Ethiopia"		
gl excel_hfps_mwi	"${hfps_github}/Excel documentation/Malawi"		
gl excel_hfps_nga	"${hfps_github}/Excel documentation/Nigeria"		
gl excel_hfps_tza	"${hfps_github}/Excel documentation/Tanzania"		
gl excel_hfps_uga	"${hfps_github}/Excel documentation/Uganda"		
gl excel_hfps_pnl	"${hfps_github}/Excel documentation/Panel"			
