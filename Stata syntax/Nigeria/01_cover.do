...
d using	"${raw_hfps_nga2}/p2r11_sect_a_6_6d_13b_12.dta"

label_inventory `"${raw_hfps_nga1}"', pre(`"r"')	suf(`"_12.dta"') varname vallab 	/*vardetail varname diagnostic retain*/  
label_inventory `"${raw_hfps_nga2}"', pre(`"p2r"' )	suf(`"_12.dta"') varname vallab 	/*vardetail varname diagnostic retain*/  
...
keep round-interviewer_id wt_baseline 
	...
	wt_p2round10 wt_p2round10_panel
	wt_p2round11 wt_p2round11_panel
	;
#d cr
	...
	isid hhid round
	sort hhid round
	order wt_round* wt_youth_r12 wt_p2round? wt_p2round1? wt_r*panel wt_youth_r12_panel wt_p2round?_panel wt_p2round1?_panel, a(wt_baseline)
	d s2a*
	drop s2aq3-s2aq18_os
	
	d
	tabstat wt_*, by(round) s(sum) format(%12.3gc)
	egen wgt = rowfirst(wt_baseline wt_round2 wt_round3 wt_round4 wt_round5 wt_round6 wt_round7 wt_round8 wt_round9 wt_round10 wt_round11 wt_youth_r12 wt_p2round1 wt_p2round2 wt_p2round3 wt_p2round4 wt_p2round5 wt_p2round6 wt_p2round7 wt_p2round8 wt_p2round9 wt_p2round10 wt_p2round11)
	tabstat wt_*, by(round) s(n) format(%12.3gc)
	egen wgt_panel = rowfirst(wt_baseline wt_round2 wt_r3panel wt_r4panel wt_r5panel wt_r6panel wt_r7panel wt_r8panel wt_r9panel wt_r10panel wt_r11panel wt_youth_r12_panel wt_p2round3_panel wt_p2round4_panel wt_p2round5_panel wt_p2round6_panel wt_p2round7_panel wt_p2round8_panel wt_p2round9_panel wt_p2round10_panel wt_p2round11_panel)
	drop wt_*
	...
	d s12q3*	// no immediate application
	drop s12q3*
	d s12q4*
	drop s12q4*
	d s12*
	...
	recode s12q10 (96=6) if inlist(str,"started the interview with head using ibibio but ended the interview with the wife using english")
	ta str if s12q10==96	//	could code odoma and igala, but unclear what application this would have anyway 
	drop str s12q10_os
...
clear; append using
	...
	"${raw_hfps_nga2}/p2r10_sect_1.dta"
	"${raw_hfps_nga2}/p2r11_sect_1.dta"
, gen(round);
#d cr
...
sa "${tmp_hfps_nga}/cover.dta", replace 
