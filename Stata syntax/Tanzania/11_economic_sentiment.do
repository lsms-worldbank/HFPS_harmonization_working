...
d using	"${raw_hfps_tza}/r11_sect_a_2_3_4_11_12a_10.dta"	//	s4* 
...
clear; append using
	...
	, gen(round) keep(hhid select_s4-s4q9_os); 
	la drop _append; la val round .; replace round=round+8; 
#d cr 
tempfile r9p
sa		`r9p'

clear
append using `r6' `r7' `r8' `r9p'
la li _all
...
sa "${tmp_hfps_tza}/economic_sentiment.dta", replace 
u  "${tmp_hfps_tza}/economic_sentiment.dta", clear 
