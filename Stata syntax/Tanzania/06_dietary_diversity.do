...
d using	"${raw_hfps_tza}/r11_sect_12b.dta"

label_inventory `"${raw_hfps_tza}"', pre(`"r"') suf(`"_sect_12b.dta"')	/*
...
sa "${tmp_hfps_tza}/dietary_diversity.dta", replace 
