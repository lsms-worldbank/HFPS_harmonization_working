...
d using	"${raw_hfps_uga}/round18/Cover.dta"
...
d using	"${raw_hfps_uga}/round18/interview_result.dta"
*/
/*
#d ; 
label_inventory `"${raw_hfps_uga}/round1"'
...
ta rounds
	...
	sort region subreg matches rounds 
	li region subreg matches rounds, sepby(region)
...
/*	"${raw_hfps_uga}/round10/interview_result.dta"		not available in public data! */
	...
	"${raw_hfps_uga}/round18/interview_result.dta"
...
clear; append using
 ...
 "${raw_hfps_uga}/round18/Cover.dta"
