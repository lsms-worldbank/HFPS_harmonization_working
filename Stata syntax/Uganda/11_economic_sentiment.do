...
d using	"${raw_hfps_uga}/round18/SEC12.dta"
...
la li _all
u	"${raw_hfps_uga}/round18/SEC12.dta"		, clear
la li _all



foreach r of numlist 8 10 12(1)18 {
u	"${raw_hfps_uga}/round`r'/SEC12.dta", clear
uselabel _all
cleanstr label
tempfile r`r'
sa		`r`r''
...
clear; append using
	...
	"${raw_hfps_uga}/round18/SEC12.dta"	
...
sa "${tmp_hfps_uga}/economic_sentiment.dta", replace 
