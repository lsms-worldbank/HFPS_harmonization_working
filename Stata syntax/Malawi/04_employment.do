...
*	NFE
g nfe_round = inrange(round,1,5) | inrange(round,7,9) | inrange(round,11,12) | round==20
ta s6q6 round,m
...
*	revenue
tab2 round s6q13 s6qb13, first 	//	wasn't asked in r20 
egen rvnu = rowfirst(s6q13 s6qb13)	
g revenue_lbl_nfe = .
...
sa "${tmp_hfps_mwi}/employment.dta", replace 
ex


u  "${tmp_hfps_mwi}/employment.dta", clear
ta sector_cur work_cur,m
