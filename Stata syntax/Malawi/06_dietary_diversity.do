...
d using	"${raw_hfps_mwi}/sect8b_dietarydiversity_r21.dta"

label_inventory "${raw_hfps_mwi}", pre("sect8b_dietarydiversity_r") suf(".dta") varname vallab
...
clear; append using 
	...
	"${raw_hfps_mwi}/sect8b_dietarydiversity_r21.dta"
...
sa "${tmp_hfps_mwi}/dietary_diversity.dta", replace 
