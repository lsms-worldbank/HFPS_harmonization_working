...
d using	"${raw_hfps_mwi}/sect19_subjectivewelfare_r21.dta"


label_inventory "${raw_hfps_mwi}", pre(`"sect19_subjectivewelfare_r"') suf(`".dta"') vallab
...
sa "${tmp_hfps_mwi}/subjective_welfare.dta", replace
