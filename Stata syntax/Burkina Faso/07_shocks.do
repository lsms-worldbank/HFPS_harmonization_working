...
label_inventory "${raw_hfps_bfa}", pre("r") suf("_sec9_chocs.dta") varname vallab
...
sa "${tmp_hfps_bfa}/shocks.dta", replace
	
	
*	move to household level for analysis
u  "${tmp_hfps_bfa}/shocks.dta", clear
...
isid hhid round
sort hhid round
sa "${tmp_hfps_bfa}/hh_shocks.dta", replace 
