...
d using "${tmp_hfps_bfa}/dietary_diversity.dta"
// d using "${tmp_hfps_eth}/dietary_diversity.dta"
d using "${tmp_hfps_mwi}/dietary_diversity.dta"
d using "${tmp_hfps_nga}/dietary_diversity.dta"
d using "${tmp_hfps_tza}/dietary_diversity.dta"
d using "${tmp_hfps_uga}/dietary_diversity.dta"

loc dographs=0
if `dographs'==1	{
u "${tmp_hfps_bfa}/dietary_diversity.dta", clear
dens_by_round HDDS_w
u "${tmp_hfps_mwi}/dietary_diversity.dta", clear
dens_by_round HDDS_w
u "${tmp_hfps_nga}/dietary_diversity.dta", clear
dens_by_round HDDS_w
u "${tmp_hfps_tza}/dietary_diversity.dta", clear
dens_by_round HDDS_w
u "${tmp_hfps_uga}/dietary_diversity.dta", clear
dens_by_round HDDS_w
}
